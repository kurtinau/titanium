  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        <div class="panel-heading">编辑产品类别</div>
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('admin/categories/'.$category->id) }}" method="POST">
            ...
            <input type="text" name="id" class="form-control" required="required" value="{{ $category->id }}" readOnly="true">
            <br>
            <input type="text" name="name" class="form-control" required="required" value="{{ $category->name }}">
            <br>
            <button class="btn btn-lg btn-info">编辑产品类别</button>
